...
class CameroonNumberVisualTransformation : VisualTransformation {
    companion object {
        ...
        fun doFiltering(text: AnnotatedString): TransformedText {
            ...
            return TransformedText(AnnotatedString(output), cameroonNumberTranslator)
        }
    }

    override fun filter(text: AnnotatedString): TransformedText = doFiltering(text)
